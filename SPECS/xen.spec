...
Patch201: xsa433.patch
Patch202: 0001-x86-cpuid-Infrastructure-to-support-pseudo-feature-i.patch
Patch203: 0002-x86-Activate-Data-Operand-Invariant-Timing-Mode-by-d.patch
Patch204: 0001-x86-AMD-make-HT-range-dynamic-for-Fam17-and-up.patch
Patch205: 0001-tools-Fix-pkg-config-file-for-libxenstore.patch
Patch206: 0006-x86-vpt-fix-injection-to-remote-vCPU.patch
Patch207: 0003-xen-microcode-add-information-about-currently-loaded.patch
Patch208: 0004-microcode-add-sequential-application-policy.patch
Patch209: 0007-microcode-update-raw-cpuid-policy-after-a-successful.patch
Patch210: 0001-microcode-remove-panic-calls.patch
Patch211: detect-nehalem-c-state.patch
Patch212: quirk-hp-gen8-rmrr.patch
Patch213: quirk-pci-phantom-function-devices.patch
Patch214: 0001-x86-hpet-Pre-cleanup.patch
Patch215: 0002-x86-hpet-Use-singe-apic-vector-rather-than-irq_descs.patch
Patch216: 0003-x86-hpet-Post-cleanup.patch
Patch217: 0002-libxc-retry-shadow-ops-if-EBUSY-is-returned.patch
Patch218: avoid-gnt-unmap-tlb-flush-if-not-accessed.patch
Patch219: 0002-efi-Ensure-incorrectly-typed-runtime-services-get-ma.patch
...
Patch222: 0001-x86-HVM-Avoid-cache-flush-operations-during-hvm_load.patch
Patch223: 0001-libxl-Don-t-insert-PCI-device-into-xenstore-for-HVM-.patch
Patch224: 0001-x86-PoD-Command-line-option-to-prohibit-any-PoD-oper.patch
Patch225: livepatch-ignore-duplicate-new.patch
Patch226: default-log-level-info.patch
Patch227: 0001-lib-Add-a-generic-implementation-of-current_text_add.patch
Patch228: 0002-sched-Remove-dependency-on-__LINE__-for-release-buil.patch
Patch229: pygrub-Ignore-GRUB2-if-statements.patch
Patch230: libfsimage-Add-support-for-btrfs.patch
Patch231: quiet-broke-irq-affinity.patch
Patch232: 0001-x86-msr-Blacklist-various-MSRs-which-guests-definite.patch
Patch233: 0001-Hide-AVX-512-from-guests-by-default.patch
Patch234: 0001-common-page_alloc-don-t-idle-scrub-before-microcode-.patch
Patch235: 0001-xsm-hide-detailed-Xen-version-from-unprivileged-gues.patch
Patch236: xen-tweak-cmdline-defaults.patch
Patch237: xen-tweak-debug-overhead.patch
Patch238: tweak-iommu-policy.patch
Patch239: tweak-sc-policy.patch
Patch240: disable-core-parking.patch
Patch241: 0001-Allocate-space-in-structs-pre-emptively-to-increase-.patch
Patch242: 0001-x86-mm-partially-revert-37201c62-make-logdirty-and-i.patch
Patch243: hitachi-driver-domain-ssid.patch
Patch244: livepatch-payload-in-header.patch
Patch245: xen-define-offsets-for-kdump.patch
Patch246: xen-scheduler-auto-privdom-weight.patch
Patch247: xen-hvm-disable-tsc-ramping.patch
Patch248: xen-default-cpufreq-governor-to-performance-on-intel.patch
Patch249: 0001-Partially-revert-08754333892-hvmloader-limit-CPUs-ex.patch
Patch250: 0001-x86-pv-silently-discard-writes-into-MSR_AMD64_LS_CFG.patch
Patch251: i8259-timers-pick-online-vcpu.patch
Patch252: revert-ca2eee92df44.patch
...
Patch267: xenguest.patch
Patch268: xen-vmdebug.patch
Patch269: oxenstore-extra-debug.patch
Patch270: oxenstore-censor-sensitive-data.patch
Patch271: oxenstore-large-packets.patch
Patch272: nvidia-vga.patch
Patch273: hvmloader-disable-pci-option-rom-loading.patch
Patch274: xen-force-software-vmcs-shadow.patch
Patch275: 0001-x86-vvmx-add-initial-PV-EPT-support-in-L0.patch
Patch276: use-msr-ll-instead-of-vmcs-efer.patch
Patch277: add-pv-iommu-headers.patch
Patch278: add-pv-iommu-local-domain-ops.patch
Patch279: add-pv-iommu-foreign-support.patch
Patch280: upstream-pv-iommu-tools.patch
Patch281: allow-rombios-pci-config-on-any-host-bridge.patch
Patch282: 0007-hypercall-XENMEM_get_mfn_from_pfn.patch
Patch283: gvt-g-hvmloader+rombios.patch
Patch284: xen-spec-ctrl-utility.patch
Patch285: 0001-hvmloader-acpi-add-TPM-version-option.patch
Patch286: 0002-hvmloader-acpi-add-TPM2.patch
